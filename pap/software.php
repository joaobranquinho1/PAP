	...
	<div id="site_content">		
	  ...
	  <div class="sidebar_container">       
       ...
       <div id="content">
	    ...
	    <li class="show"><img width="680" height="250" src="images/software1.png"/></li> 
       <div id='cssmenu'>
<ul>
...
<tr>
 ...
 //*********************************************************************
 $sql = "SELECT * FROM produtos where tipo='software' ORDER BY RAND()";
 GeraColunas(3, $sql)
 ?>
</td>
</tr>
...
echo ("<table width='100%' border='0'>\n");
 ...
 for ($intCont = 0; $intCont < $pNumColunas; $intCont++) {
  ...
  echo "<tr>";
  echo "<td width='250' height='141' valign='middle'><div align='center'><img src='software/".$img."' border='0' width='80' height='80' /></div></td>";
echo "</tr>";
  echo "<tr>";
  echo "<td>";
