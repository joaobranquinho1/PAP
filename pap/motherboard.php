	...
	<div id="site_content">
	  ...
	  <div class="sidebar_container">
       ...
       <div id="content">
        ...
        <li class="show"><img width="680" height="250" src="images/motherboard1.jpg"/></li>
		<div id='cssmenu'>
<ul>
...
<tr>
 ...
 //*********************************************************************
 $sql = "SELECT * FROM produtos where tipo='motherboard' ORDER BY RAND()";
 GeraColunas(3, $sql)
 ?>
</td>
</tr>
...
echo ("<table width='100%' border='0'>\n");
 ...
 for ($intCont = 0; $intCont < $pNumColunas; $intCont++) {
  ...
  echo "<tr>";
  echo "<td width='250' height='141' valign='middle'><div align='center'><img src='motherboard/".$img."' border='0' width='80' height='80' /></div></td>";
echo "</tr>";
  echo "<tr>";
  echo "<td>";
...
?>
	...
	<div id="content_grey">
	   <br><p> Telemóvel: 969367896 |E-mail: jgbranquinho@hotmail.com </p></br>
